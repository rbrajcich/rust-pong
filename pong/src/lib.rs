...
const PONG_WINDOW_TITLE: &str = "Pong Remake";
...
const MIDLINE_DASH_WIDTH: f32 = 0.005 * ARENA_WIDTH;
const MIDLINE_DASH_HEIGHT: f32 = 0.055 * ARENA_HEIGHT;
...
const BALL_MOVE_SPEED: f32 = 0.9 * ARENA_WIDTH;
...
// Font resizing
const FONT_RESIZE_DEBOUNCE_TIME: f32 = 0.5; // seconds
